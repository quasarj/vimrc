...
" Syntax highlighting
hi Comment      guifg=#8a8a8a gui=italic ctermfg=245
hi Todo         guifg=#8f8f8f gui=italic
hi Constant     guifg=#e5786d gui=none ctermfg=178
hi String       guifg=#ff5f00 gui=none ctermfg=202
" Identifier: ???
...
hi Statement    ctermfg=33 cterm=bold guifg=#0087ff gui=bold 
" Keyword:  ???
hi Keyword      guifg=#8ac6f2 gui=none ctermfg=178
hi PreProc      guifg=#e5786d gui=none ctermfg=213
hi Include      ctermfg=213 guifg=#ff87ff
hi Number       guifg=#00ffff gui=none ctermfg=51
